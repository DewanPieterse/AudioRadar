...
% disp(['Range Resolution (Entered) = ' num2str(roundn(RangeResolution,-3)) ' m']);
% disp(['Range Resolution (Using Bandwidth)= ' num2str(roundn(RangeResolution_m,-3)) ' m']);
...
% disp(['Duty Cycle = ' num2str(roundn((T/PRI)*100,-3)) ' %']);
% disp(' ');
...
Rx_Signal = highpass(Rx_Signal, (fc - B/2), fs,'ImpulseResponse','fir','Steepness',0.8);
plot(Rx_Signal);
